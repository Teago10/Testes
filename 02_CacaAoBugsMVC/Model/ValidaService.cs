...
namespace _02_CacaAoBugsMVC.Model
{
    public class ValidaService
    {
        /*
         ...
         - não pode conter 3 letras repetidas
        ...
        */
        ...
        /*
          padrão:
        - Valida nota de 0..10
        - Aceita decimais, aceitando ponto(.) ou virgula(,) como separador de decimal
        ...
        public bool ValidaNota(string notaEntrada, out double nota)
        {
            nota = -1;
